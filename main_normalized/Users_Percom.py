"""Python translation of MATLAB Users_Percom.m."""
...
def main():
    ...
    plt.xticks(x_data)
    plt.xlabel("Number of people per community", fontsize=18)
    plt.ylabel("QoE", fontsize=18)
    plt.legend(["Proposed", "LMPC", "GMPC", "HC", "RAC", "NCC", "NAV"], loc="best", fontsize=12)
    plt.grid(True)
    plt.savefig("Figure/Users_Percom.png", bbox_inches="tight")
