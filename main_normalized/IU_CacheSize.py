"""Python translation of MATLAB IU_CacheSize.m."""
...
def main():
    ...
    plt.xlim([2, number * 2])
    plt.xticks(x_data)
    plt.xlabel("Cache size of IU (Files)", fontsize=18)
    plt.ylabel("QoE", fontsize=18)
    plt.legend(["Proposed", "LMPC", "GMPC", "HC", "RAC", "NCC", "NAV"], loc="best", fontsize=12)
    plt.grid(True)
    plt.savefig("Figure/IU_CacheSize.png", bbox_inches="tight")
