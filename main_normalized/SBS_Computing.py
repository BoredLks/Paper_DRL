"""Python translation of MATLAB SBS_Computing.m."""
...
def main():
    ...
    x_data = np.arange(1, number + 1) * 20
    ...
    plt.xlim([20, number * 20])
    plt.xticks(x_data)
    plt.xlabel("SBS Computing Power (Mbit/s)", fontsize=18)
    plt.ylabel("QoE", fontsize=18)
    plt.legend(["Proposed", "LMPC", "GMPC", "HC", "RAC", "NCC", "NAV"], loc="best", fontsize=12)
    plt.grid(True)
    plt.savefig("Figure/SBS_Computing.png", bbox_inches="tight")
