"""Algorithm 3 translated from MATLAB algorithm_3.m."""

# 算法 3（HC）采用“混合缓存”策略：
# - 每个社区的 SBS 负责缓存该社区全局最热门的若干文件；
# - 剩余文件由 IU 分散缓存，避免重复。
# 其它步骤与算法 0 相同。
...
from .cal_cache_decision_3 import cal_cache_decision_3
...
def algorithm_3(
    ...
    cache_decision = cal_cache_decision_3(
        h,
        user_per_community,
        total_users,
        F,
