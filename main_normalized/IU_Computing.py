"""Python translation of MATLAB IU_Computing.m."""
...
def main():
    ...
    x_data = np.arange(1, number + 1) * 1.5
    ...
    plt.xlim([1.5, number * 1.5])
    plt.xticks(x_data)
    plt.xlabel("IU Computing Power (Mbit/s)", fontsize=18)
    plt.ylabel("QoE", fontsize=18)
    plt.legend(["Proposed", "LMPC", "GMPC", "HC", "RAC", "NCC", "NAV"], loc="best", fontsize=12)
    plt.grid(True)
    plt.savefig("Figure/IU_Computing.png", bbox_inches="tight")
